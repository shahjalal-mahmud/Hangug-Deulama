...
|                                    Top Picks For you                                     |                                      login                                      |                                       Register                                        |
| :--------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------: |
| <img src="docs/screenshots/mobile/toppicks.png" width="260" alt="mobile — Top Picks For You" /> | <img src="docs/screenshots/mobile/login.png" width="260" alt="mobiile — Login page" /> | <img src="docs/screenshots/mobile/register.png" width="260" alt="mobile — Register page" /> |
