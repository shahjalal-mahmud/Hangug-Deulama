...
- Backend is stateless PHP 8 with JWT (HS256) and one standard response
  ...
  (PROJECT.md §10, §15.11; docs/api.md "Standard Response Format").
...
- per PROJECT.md §14 and §7.6: rule-based engine. Signals blended per
  ...
  weighted higher.
- per PROJECT.md §14.1 and docs/api.md §"GET /api/recommendations":
...
- per PROJECT.md §14.2 and docs/api.md §"GET /api/profile/genre-statistics":
